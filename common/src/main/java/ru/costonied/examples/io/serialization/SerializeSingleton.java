...
/**
 * Example describes how to serialize and deserialize Singleton in proper way.
 *
 * The main idea in the example is using method - private Object readResolve().
 * Method readResolve() help to return the singleton object (not new object)
 * while deserialize object from stream.
 * Without method readResolve() in the example, method deserializeSingletonInstance()
 * will be return every time new objects. You could check it if comment readResolve() method.
 */
